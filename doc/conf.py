...
#
# django-user-profiles documentation build configuration file, created by
...
project = u'django-user-profiles'
...
latex_documents = [
  ('index', 'DjangoMediaTree.tex', u'django-user-profiles Documentation',
